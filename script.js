...
// Add categories and tasks using JavaScript
...
//    Get all the tasks for the current category
    const categoryTasks = tasks.filter(
      (task) => task.category.toLowerCase() === category.title.toLowerCase()
    );

    // Create a div to render the category
...
const renderTasks=() =>{
    ...
    if(categoryTasks.length ===0 ){
        ...
        // if there are tasks in the selected category
...
// render all the categories in selection
